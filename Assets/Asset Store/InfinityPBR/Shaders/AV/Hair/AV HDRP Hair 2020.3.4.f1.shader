...
Shader "AV/HDRP/Hair 2020.3.4.f1"
{
	Properties
	{
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin]_OpacityMaskMultiplier("Opacity Mask Multiplier", Float) = 4
		...
		[ASEEnd]_HairVariationHardness("Hair Variation Hardness", Range( 0 , 1)) = 0.3
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_14_0_g144 = ( frac( ( packedInput.ase_texcoord5.xy.y * 2.0 ) ) + _HairVariationPosition );
				float smoothstepResult2_g144 = smoothstep( _HairVariationHardness , temp_output_12_0_g144 , temp_output_14_0_g144);
				float3 lerpResult6_g144 = lerp( (_HairVariationColor).rgb , temp_output_16_0_g144 , smoothstepResult2_g144);
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 temp_output_16_0_g144 = _Color.rgb;
				float temp_output_12_0_g144 = ( 1.0 - _HairVariationHardness );
				float temp_output_14_0_g144 = ( frac( ( packedInput.ase_texcoord.xy.y * 2.0 ) ) + _HairVariationPosition );
				float smoothstepResult2_g144 = smoothstep( _HairVariationHardness , temp_output_12_0_g144 , temp_output_14_0_g144);
				float3 lerpResult6_g144 = lerp( (_HairVariationColor).rgb , temp_output_16_0_g144 , smoothstepResult2_g144);
				float3 lerpResult9_g144 = lerp( temp_output_16_0_g144 , lerpResult6_g144 , _HairVariationBlend);
				float3 temp_output_1302_0 = ( ( ( lerpResult1446 * ( ( _AlbedoRemapper + _AlbedoMax ) - temp_output_7_0_g147 ) ) + temp_output_7_0_g147 ) * lerpResult9_g144 );
		...
		Pass
		{
						...
						)
			{
				...
				float3 temp_output_16_0_g144 = _Color.rgb;
				float temp_output_12_0_g144 = ( 1.0 - _HairVariationHardness );
				float temp_output_14_0_g144 = ( frac( ( packedInput.ase_texcoord7.xy.y * 2.0 ) ) + _HairVariationPosition );
				float smoothstepResult2_g144 = smoothstep( _HairVariationHardness , temp_output_12_0_g144 , temp_output_14_0_g144);
				float3 lerpResult6_g144 = lerp( (_HairVariationColor).rgb , temp_output_16_0_g144 , smoothstepResult2_g144);
				float3 lerpResult9_g144 = lerp( temp_output_16_0_g144 , lerpResult6_g144 , _HairVariationBlend);
				float3 temp_output_1302_0 = ( ( ( lerpResult1446 * ( ( _AlbedoRemapper + _AlbedoMax ) - temp_output_7_0_g147 ) ) + temp_output_7_0_g147 ) * lerpResult9_g144 );
...
/*ASEBEGIN
Version=18900
732;320;1154;593;-739.3455;661.0545;2.487565;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;1336;987.3409,-381.4098;Inherit;True;Property;_MainTex;Albedo (RGB);5;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;859;1297.171,478.6919;Inherit;False;Property;_NormalIntensity;Normal Intensity;11;0;Create;True;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1329;1297.407,400.669;Inherit;False;Property;_NormalCreateOffset;Normal Create Offset;13;0;Create;True;0;0;0;False;0;False;0.35;0.35;0;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;4;1301.142,-381.1319;Inherit;True;Property;_asdasd;asdasd;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;857;1593.756,215.2041;Inherit;True;Property;_BumpMap;Normal;10;1;[Normal];Create;False;0;0;0;False;1;Header(Normal);False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.IntNode;1338;1706.276,558.4058;Inherit;False;Property;_NormalMode;Normal Mode;12;1;[Enum];Create;True;0;2;Normal;0;Normal Create;1;0;False;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;1475;1618.794,414.648;Inherit;False;Normal Create Optimized;-1;;99;2eac668477391da4384a613fcf9b1f74;3,27,4,28,4,29,4;4;1;SAMPLER2D;0;False;2;FLOAT2;0,0;False;3;FLOAT;0.5;False;4;FLOAT;2;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1450;1642.848,-136.9773;Inherit;False;Property;_AlbedoRemapper;Albedo Remapper;7;0;Create;True;0;0;0;False;0;False;0;0;-2;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1443;1642.995,-213.1946;Inherit;False;Property;_AlbedoDesaturate;Albedo Desaturate;6;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;1497;1933.86,264.4848;Inherit;False;Constant;_Vector0;Vector 0;23;0;Create;True;0;0;0;False;0;False;-1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1456;1642.711,-62.5883;Inherit;False;Property;_AlbedoMax;Albedo Max;8;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;186;1877.644,-557.7852;Float;False;Property;_Color;Color;4;1;[HDR];Create;True;0;0;0;False;1;Header(Main);False;1,1,1,0;0.254717,0.1161984,0.0276344,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1489;2131.541,-553.6588;Inherit;False;Hair Color Blend;33;;144;2668a07de1b8779428ae358f75c4816c;2,20,1,33,1;1;16;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1449;2133.024,-375.9359;Inherit;False;Remap From 0-1;-1;;147;5454cc39823be5644b26279791046fff;0;3;6;FLOAT3;0,0,0;False;7;FLOAT;0;False;8;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.NormalizeNode;1505;2343.847,-287.3391;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1487;1808.326,-658.8912;Inherit;False;1334;normal;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;1502;2258.003,-219.4318;Inherit;False;Subsurface Scattering;14;;148;5fc3947ab881fac449027203ace33981;2,110,0,167,0;2;45;FLOAT3;0,0,1;False;104;FLOAT3;0,0,0;False;1;FLOAT3;100
Node;AmplifyShaderEditor.FunctionNode;1503;2001.507,-653.6028;Inherit;False;Hair Anisotropic;20;;149;938004f063eefba4ab5538c4c89e1e18;1,81,1;2;83;FLOAT3;0,0,1;False;82;FLOAT;1;False;2;FLOAT3;0;FLOAT;93
...
Node;AmplifyShaderEditor.RangedFloatNode;1096;1388.579,28.14278;Inherit;False;Property;_OpacityMaskMultiplier;Opacity Mask Multiplier;0;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1084;2662.477,-254.8813;Inherit;False;Property;_Emission;Emission;9;0;Create;True;0;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;897;2568.595,168.4935;Inherit;False;Property;_AOIntensity;AO Intensity;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1085;2569.005,99.94745;Inherit;False;Property;_Smoothness;Smoothness;1;0;Create;True;0;0;0;False;0;False;0.5;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1092;2731.781,3.303111;Inherit;False;Property;_Metallic;Metallic;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1495;2860.134,81.14105;Inherit;False;FastMax;-1;;150;77893a230aa5d4a43b6f6510820a4d66;0;2;5;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=C271908C891F1E056CB96EE8FCF9E9FBAC0BBB43